// miniprogram/pages/country/country.js
Page({
  ...
  onLoad: function (options) {
    ...
    this.data.countryList.forEach((item, index) =>{
      if(item.en==options.country||item.cn==options.country) {
        this.setData({
          countryIndex:index
        })
        return;
  ...
  getCountry(e) {
    ...
    if(index!=this.data.countryIndex) {
      ...
      prevPage.data.userInfo.country = currPage.data.countryList[index].cn;
      prevPage.setData({
      ...
      wx.cloud.callFunction({
        ...
        data:{
          ...
          content:{
            data:{
              country:currPage.data.countryList[index].cn
            }
          }
        }
      })
